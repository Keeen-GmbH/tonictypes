...
loadHelp() {
    ...
    read -r -d '' HELP <<EOF
TYPO3 core–style test runner for tonictypes. Execute unit, functional and other test suites in
...
DATABASE_DRIVER=""
CONTAINER_BIN=""
COMPOSER_ROOT_VERSION="2.1.0-dev"
CONTAINER_INTERACTIVE="-it --init"
HOST_UID=$(id -u)
HOST_PID=$(id -g)
USERSET=""
SUFFIX=$(echo $RANDOM)
NETWORK="tonictypes-${SUFFIX}"
CI_PARAMS="${CI_PARAMS:-}"
CI_PARAMS_ARRAY=()
