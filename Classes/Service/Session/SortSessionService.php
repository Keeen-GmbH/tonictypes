...
class SortSessionService extends SessionService
{
     ...
     * @var string
     */
    public const SESSION_PREFIX_KEY = 'tx-tonictypes-sort';

    /**
     * Session Keys for Sorting
     * @var string
     */
    public const SESSION_KEY_SORT_ORDER 	= 'tx-tonictypes-sort-order';
    public const SESSION_KEY_SORT_BY	 	= 'tx-tonictypes-sort-by';
    public const SESSION_KEY_IS_SET		= 'tx-tonictypes-sort-is-set';
