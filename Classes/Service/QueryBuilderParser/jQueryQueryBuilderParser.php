...
class jQueryQueryBuilderParser
{
     ...
     * @return QueryBuilder
     */
    protected function loopThroughRules(array $rules, QueryBuilder $queryBuilder, $queryCondition = 'AND'): QueryBuilder
    {
     ...
     * @throws \Exception
     */
    protected function makeQuery(QueryBuilder $queryBuilder, stdClass $rule, $queryCondition = 'AND'): QueryBuilder
    {
     ...
     * @return QueryBuilder
     */
    protected function convertIncomingQBtoQuery(QueryBuilder $queryBuilder, stdClass $rule, $value, string $queryCondition = 'AND'): QueryBuilder
    {
        // Convertissez l'opérateur (LIKE / NOT LIKE / GREATER THAN) qui nous est fourni par QueryBuilder
        // sur un que nous pouvons utiliser à l'intérieur de la requête SQL
        $sqlOperator = $this->operator_sql[$rule->operator];
     ...
     * @return QueryBuilder
     */
    protected function createNestedQuery(QueryBuilder $queryBuilder, stdClass $rule, ?string $condition = null): QueryBuilder
    {
        if ($condition === null) {
