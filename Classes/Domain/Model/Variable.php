...
class Variable extends AbstractModel
{
     ...
     * @var int
     */
    public const VARIABLE_TYPE_FIXED 			    = 0;
    public const VARIBALE_TYPE_TYPOSCRIPT 		    = 1;
    public const VARIABLE_TYPE_TYPOSCRIPT_VAR      = 2;
    public const VARIABLE_TYPE_GET				    = 3;
    public const VARIABLE_TYPE_POST			    = 4;
    public const VARIABLE_TYPE_GET_POST			= 5;
    //const VARIABLE_TYPE_RECORD_FIELD	    = 6;
    public const VARIABLE_TYPE_DATABASE		    = 7;
    public const VARIABLE_TYPE_FRONTEND_USER	    = 8;
    public const VARIABLE_TYPE_SERVER			    = 9;
    public const VARIABLE_TYPE_DYNAMIC_RECORD	    = 10;
    public const VARIABLE_TYPE_USER_SESSION	    = 11;
    public const VARIABLE_TYPE_PAGE			    = 12;
    public const VARIABLE_TYPE_USERFUNC		    = 13;
    public const VARIABLE_TYPE_BACKEND_USER	    = 14;
    public const VARIABLE_TYPE_LANGUAGE_UID	    = 15;
    public const VARIABLE_TYPE_SESSION_CONTAINER   = 16;
    public const VARIABLE_TYPE_EXTENSION_CONFIG    = 17;
    public const VARIABLE_TYPE_TYPOSCRIPT_SETTINGS = 18;
     ...
     * @var int
     */
    public const VARIABLE_TYPE_CAST_NONE		= 0;
    public const VARIABLE_TYPE_CAST_BOOLEAN 	= 1;
    public const VARIABLE_TYPE_CAST_INTEGER	= 2;
    public const VARIABLE_TYPE_CAST_FLOAT		= 3;
    public const VARIABLE_TYPE_CAST_STRING		= 4;
    public const VARIABLE_TYPE_CAST_ARRAY		= 5;
    public const VARIABLE_TYPE_CAST_OBJECT		= 6;
    public const VARIABLE_TYPE_CAST_NULL		= 7;
